  ...
  <header class="navbar">
    ...
    >
      <!-- <img
        ...
        :alt="$siteTitle"
      > -->
      <svg class="logo" xmlns="http://www.w3.org/2000/svg" width="130.954" height="32.513" viewBox="0 0 130.954 32.513">
        <path id="Path_7" data-name="Path 7" d="M.342-9.6H2.717L5.3-2.337,7.923-9.6h2.261L6.384,0H4.161ZM16.3.3A4.381,4.381,0,0,1,13.129-.779a4.055,4.055,0,0,1-1.121-3.059V-9.6h2.185v5.719q0,2.242,2.128,2.242,2.09,0,2.09-2.242V-9.6H20.6v5.757A4.075,4.075,0,0,1,19.485-.779,4.374,4.374,0,0,1,16.3.3ZM28.481.3a6.506,6.506,0,0,1-2.869-.6,4.408,4.408,0,0,1-1.919-1.758,5.247,5.247,0,0,1-.684-2.717,5.631,5.631,0,0,1,.6-2.622,4.563,4.563,0,0,1,1.7-1.833A4.778,4.778,0,0,1,27.854-9.9a4.677,4.677,0,0,1,2.327.57,3.959,3.959,0,0,1,1.587,1.653,5.35,5.35,0,0,1,.57,2.527,5.688,5.688,0,0,1-.076,1.083H25.194a2.877,2.877,0,0,0,1.111,1.91,3.852,3.852,0,0,0,2.365.675,7.276,7.276,0,0,0,3.23-.741l.228,1.71a6.535,6.535,0,0,1-1.672.6A8.955,8.955,0,0,1,28.481.3ZM30.21-5.719a2.782,2.782,0,0,0-.7-1.824,2.3,2.3,0,0,0-1.729-.646,2.469,2.469,0,0,0-1.767.646,2.931,2.931,0,0,0-.836,1.824Z" transform="translate(98.616 26.446)" fill="#324e58" opacity="0.59"/>
