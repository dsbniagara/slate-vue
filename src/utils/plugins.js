...
export function registerComponent (Vue, name, def) {
    Vue._slate_vue_components_ = Vue._slate_vue_components_ || {}
    const loaded = Vue._slate_vue_components_[name]
    if (!loaded && def && name) {
      Vue._slate_vue_components_[name] = true
  ...
  export function registerDirective (Vue, name, def) {
    Vue._slate_vue_directives_ = Vue._slate_vue_directives_ || {}
    const loaded = Vue._slate_vue_directives_[name]
    if (!loaded && def && name) {
      Vue._slate_vue_directives_[name] = true
